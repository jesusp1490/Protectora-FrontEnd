...
const SponsorPage = () => {
  return (
    <div className='sponsor-section-container'>
      ...
      <ul className="pSponsor-center-list">
        <li className='pSponsor-li'>Actualizaciones Exclusivas: Recibe noticias periódicas sobre el progreso y las travesuras de tu amigo peludo.</li>
        <li className='pSponsor-li'>Contenido Exclusivo: Accede a fotos y momentos especiales que solo compartimos con nuestros padrinos.</li>
        <li className='pSponsor-li'>Invitaciones a Eventos Especiales: Celebra la conexión especial que tienes con tu ahijado en eventos exclusivos.</li>
      </ul>
      
      <h2 className='titleSponsor2'>Cómo Apadrinar en Lucky:</h2>
      <ul className="pSponsor-center-list">
        <li className='pSponsor-li'>Selecciona a tu Compañero: Explora la galería de animales y elige al que haga latir más fuerte tu corazón.</li>
        <li className='pSponsor-li'>Realiza tu Donación Segura: Haz tu donación segura en línea y comienza tu viaje como padrino en Lucky.</li>
      </ul>

      <h2 className='titleSponsor2'>Contáctanos en Lucky:</h2>
      <p className='pSponsor'>
        Si tienes preguntas o necesitas más información sobre nuestro programa de apadrinamiento, no dudes en contactarnos en adopcion@lucky.org o llámanos al <strong>+1-123-456-7891</strong>.
      </p>
